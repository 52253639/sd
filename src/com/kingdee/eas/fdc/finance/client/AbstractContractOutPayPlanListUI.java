 ...
 * output class name
 */
public abstract class AbstractContractOutPayPlanListUI extends com.kingdee.eas.fdc.contract.client.ContractListBaseUI
{
     ...
     */
    public AbstractContractOutPayPlanListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractContractOutPayPlanListUI.class.getName());
...
contBillList.getContentPane().setLayout(new BorderLayout(0, 0));        contBillList.getContentPane().add(tblPayRequestBill, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.finance.app.ContractOutPayPlanListUIHandler";
	}
    ...
    protected class ActionModify extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractContractOutPayPlanListUI.this, "ActionModify", "actionModify_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.finance.client", "ContractOutPayPlanListUI");
    }
    /**
