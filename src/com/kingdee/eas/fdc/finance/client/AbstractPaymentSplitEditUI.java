...
public abstract class AbstractPaymentSplitEditUI extends com.kingdee.eas.fdc.basedata.client.FDCSplitBillEditUI
{
    ...
    public void initUIContentLayout()
    {
        ...
        kDLabelContainer3.setBounds(new Rectangle(733, 58, 270, 19));
        this.add(kDLabelContainer3, new KDLayout.Constraints(733, 58, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        kDLabelContainer5.setBounds(new Rectangle(351, 58, 270, 19));
        this.add(kDLabelContainer5, new KDLayout.Constraints(351, 58, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        kdtEntrys.setBounds(new Rectangle(10, 82, 993, 461));
        this.add(kdtEntrys, new KDLayout.Constraints(10, 82, 993, 461, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        contCostAmt.setBounds(new Rectangle(10, 58, 270, 19));
        this.add(contCostAmt, new KDLayout.Constraints(10, 58, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        contInvoice.setBounds(new Rectangle(10, 58, 270, 19));
        this.add(contInvoice, new KDLayout.Constraints(10, 58, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        separator7.setBounds(new Rectangle(247, 276, 6, 10));
        this.add(separator7, new KDLayout.Constraints(247, 276, 6, 10, 0));
        contSplitInvoice.setBounds(new Rectangle(351, 58, 270, 19));
        this.add(contSplitInvoice, new KDLayout.Constraints(351, 58, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        //kDLabelContainer1
