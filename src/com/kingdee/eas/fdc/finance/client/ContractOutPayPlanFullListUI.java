 ...
 * output class name
 */
public class ContractOutPayPlanFullListUI extends AbstractContractOutPayPlanFullListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ContractOutPayPlanFullListUI.class);
    
    public ContractOutPayPlanFullListUI() throws Exception
    {
        super();
    }
	...
	public void onLoad() throws Exception {
		...
		CRMClientHelper.changeTableNumberFormat(tblMain, new String[]{"contract.amount"});
	}

	protected void afterTableFillData(KDTDataRequestEvent e) {
		super.afterTableFillData(e);
		CRMClientHelper.getFootRow(tblMain, new String[]{"contract.amount","amount"});
	}
	/**
