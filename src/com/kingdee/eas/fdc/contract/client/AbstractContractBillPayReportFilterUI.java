...
public abstract class AbstractContractBillPayReportFilterUI extends com.kingdee.eas.framework.report.client.CommRptBaseConditionUI
{
     ...
     */
    public AbstractContractBillPayReportFilterUI() throws Exception
    {
        super();
        jbInit();
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.contract.app.ContractBillPayReportFilterUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.contract.client", "ContractBillPayReportFilterUI");
    }
