 ...
 * output class name
 */
public abstract class AbstractWorkFlowReportFilterUI extends com.kingdee.eas.framework.report.client.CommRptBaseConditionUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractWorkFlowReportFilterUI.class);
     ...
     */
    public AbstractWorkFlowReportFilterUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractWorkFlowReportFilterUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        contPerson.setBounds(new Rectangle(16, 19, 564, 19));
        this.add(contPerson, null);
        contFromDate.setBounds(new Rectangle(16, 56, 270, 19));
        this.add(contFromDate, null);
        contToDate.setBounds(new Rectangle(310, 56, 270, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.contract.app.WorkFlowReportFilterUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.contract.client", "WorkFlowReportFilterUI");
    }
