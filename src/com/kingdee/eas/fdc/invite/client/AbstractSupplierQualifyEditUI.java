...
public abstract class AbstractSupplierQualifyEditUI extends com.kingdee.eas.fdc.invite.client.BaseInviteEditUI
{
    ...
    private void jbInit() throws Exception
    {
        ...
        this.kdtEntry.addKDTEditListener(new com.kingdee.bos.ctrl.kdf.table.event.KDTEditAdapter() {
                ...
                this.kdtEntry.putBindContents("editData",new String[] {"supplier","linkPerson","linkPhone","supplierState","recommended","supplier.grade.name","supplier.quaLevel.name","score1","score2","result","reason","coState","manager","isAccept","remark"});
