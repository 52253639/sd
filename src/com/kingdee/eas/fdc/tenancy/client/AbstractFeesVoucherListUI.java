 ...
 * output class name
 */
public abstract class AbstractFeesVoucherListUI extends com.kingdee.eas.fdc.basedata.client.FDCBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractFeesVoucherListUI.class);
     ...
     */
    public AbstractFeesVoucherListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractFeesVoucherListUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.tenancy.app.FeesVoucherListUIHandler";
	}
    ...
    protected class ActionSetAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractFeesVoucherListUI.this, "ActionSetAudit", "actionSetAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionSetUnaudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractFeesVoucherListUI.this, "ActionSetUnaudit", "actionSetUnaudit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.tenancy.client", "FeesVoucherListUI");
    }
