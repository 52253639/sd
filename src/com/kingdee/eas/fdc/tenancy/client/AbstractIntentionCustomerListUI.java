 ...
 * output class name
 */
public abstract class AbstractIntentionCustomerListUI extends com.kingdee.eas.fdc.basedata.client.FDCBillListUI
{
     ...
     */
    public AbstractIntentionCustomerListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractIntentionCustomerListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.fdc.tenancy.app", "IntentionCustomerQuery");
        //actionAudit
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.tenancy.app.IntentionCustomerListUIHandler";
	}
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractIntentionCustomerListUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.tenancy.client", "IntentionCustomerListUI");
    }
