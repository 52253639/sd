...
public abstract class AbstractRestReceivableListUI extends com.kingdee.eas.framework.client.CoreBillListUI
{
    ...
    {
        return new String[] {"id","number","bizDate","tenancyBill","tenancyBill.tenCustomerDes","billState","creator.name","auditor.name","auditDate","createTime","description"};
    }
