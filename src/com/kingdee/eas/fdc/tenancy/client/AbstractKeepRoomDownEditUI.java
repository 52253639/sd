 ...
 * output class name
 */
public abstract class AbstractKeepRoomDownEditUI extends com.kingdee.eas.framework.client.BillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractKeepRoomDownEditUI.class);
     ...
     */
    public AbstractKeepRoomDownEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractKeepRoomDownEditUI.class.getName());
        ...
        this.btChooseRoom.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent e) {
                ...
                try {
                    btChooseRoom_actionPerformed(e);
                } catch (Exception exc) {
                    handUIException(exc);
                } finally {
    ...
    {
        this.setBounds(new Rectangle(0, 0, 480, 300));
        this.setLayout(null);
        kDLabelContainer1.setBounds(new Rectangle(17, 12, 270, 19));
        this.add(kDLabelContainer1, null);
        kDLabelContainer2.setBounds(new Rectangle(17, 49, 270, 19));
        this.add(kDLabelContainer2, null);
        kDLabelContainer3.setBounds(new Rectangle(17, 85, 270, 19));
        this.add(kDLabelContainer3, null);
        kDLabelContainer4.setBounds(new Rectangle(17, 121, 270, 19));
        this.add(kDLabelContainer4, null);
        kDLabelContainer5.setBounds(new Rectangle(17, 159, 431, 66));
        this.add(kDLabelContainer5, null);
        btChooseRoom.setBounds(new Rectangle(318, 48, 86, 21));
        this.add(btChooseRoom, null);
        //kDLabelContainer1
        kDLabelContainer1.setBoundEditor(txtNumber);
        //kDLabelContainer2
        kDLabelContainer2.setBoundEditor(txtRoom);
        //kDLabelContainer3
        kDLabelContainer3.setBoundEditor(dateBizDate);
        //kDLabelContainer4
        kDLabelContainer4.setBoundEditor(txtOperator);
        //kDLabelContainer5
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.tenancy.app.KeepRoomDownEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.tenancy.KeepRoomDownInfo)ov;
    }
    ...
    /**
     * output btChooseRoom_actionPerformed method
     */
    protected void btChooseRoom_actionPerformed(java.awt.event.ActionEvent e) throws Exception
    {
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.tenancy.client", "KeepRoomDownEditUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.fdc.tenancy.client.KeepRoomDownEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.fdc.tenancy.KeepRoomDownFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.fdc.tenancy.KeepRoomDownInfo objectValue = new com.kingdee.eas.fdc.tenancy.KeepRoomDownInfo();
    	...
    	return "/bim/fdc/tenancy/KeepRoomDown";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.fdc.tenancy.app.KeepRoomDownQuery");
	}
