 ...
 * output class name
 */
public class FeesWarrantFeeListFilterUI extends AbstractFeesWarrantFeeListFilterUI
{
    private static final Logger logger = CoreUIObject.getLogger(FeesWarrantFeeListFilterUI.class);
    ...
    public FeesWarrantFeeListFilterUI() throws Exception
    {
        super();
    }
    public FeesWarrantFeeListFilterUI(ListUI listUI, ItemAction actionListOnLoad)
	throws Exception {
    	super();
    	this.listUI = listUI;
...
//			   filter.getFilterItems().add(new FilterItemInfo("sellProject.id", CommerceHelper.getPermitProjectIds(),CompareType.INNER));
   ...
   public void clear() {
    ...
    {
        super.isAudit_actionPerformed(e);
    }
