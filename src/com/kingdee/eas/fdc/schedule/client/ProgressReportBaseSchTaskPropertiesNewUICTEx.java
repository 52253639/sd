...
public class ProgressReportBaseSchTaskPropertiesNewUICTEx extends ProgressReportBaseSchTaskPropertiesNewUI{

	public ProgressReportBaseSchTaskPropertiesNewUICTEx() throws Exception {
		super();
	}
	public void load() {
		super.load();
