 ...
 * output class name
 */
public abstract class AbstractRoomAccountReportUI extends com.kingdee.eas.framework.report.client.CommRptBaseUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractRoomAccountReportUI.class);
     ...
     */
    public AbstractRoomAccountReportUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractRoomAccountReportUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.sellhouse.report.RoomAccountReportUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.sellhouse.report", "RoomAccountReportUI");
    }
