...
public class TimeAccountReportFacadeControllerBean extends AbstractTimeAccountReportFacadeControllerBean
{
    ...
    protected RptParams _createTempTable(Context ctx, RptParams params)    throws BOSException, EASBizException
	{
	    ...
	    initColoum(header,col,"preAmount",60,false);
	    initColoum(header,col,"preArea",100,false);
	    initColoum(header,col,"preAccount",140,false);
	    initColoum(header,col,"preAverage",100,false);
	    initColoum(header,col,"quitPreAmount",60,false);
	    initColoum(header,col,"quitPreArea",100,false);
	    initColoum(header,col,"quitPreAccount",140,false);
	    initColoum(header,col,"quitPreAverage",100,false);
	    initColoum(header,col,"purAmount",60,false);
	    initColoum(header,col,"purArea",100,false);
	    initColoum(header,col,"purAccount",140,false);
	    initColoum(header,col,"purAverage",100,false);
	    initColoum(header,col,"signPreAmount",60,false);
	    initColoum(header,col,"signPreArea",100,false);
	    initColoum(header,col,"signPreAccount",140,false);
	    initColoum(header,col,"signPreAverage",100,false);
	    initColoum(header,col,"unSignPurAmount",60,false);
	    initColoum(header,col,"unSignPurArea",100,false);
	    initColoum(header,col,"unSignPurAccount",140,false);
	    initColoum(header,col,"unSignPurAverage",100,false);
	    initColoum(header,col,"signPurAmount",60,false);
	    initColoum(header,col,"signPurArea",100,false);
	    initColoum(header,col,"signPurAccount",140,false);
	    initColoum(header,col,"signPurAverage",100,false);
	    initColoum(header,col,"directSignAmount",60,false);
	    initColoum(header,col,"directSignArea",100,false);
	    initColoum(header,col,"directSignAccount",140,false);
	    initColoum(header,col,"directSignAverage",100,false);
	    initColoum(header,col,"quitPurAmount",60,false);
	    initColoum(header,col,"quitPurArea",100,false);
	    initColoum(header,col,"quitPurAccount",140,false);
	    initColoum(header,col,"quitPurAverage",100,false);
	    ...
	    initColoum(header,col,"signAverage",100,false);
