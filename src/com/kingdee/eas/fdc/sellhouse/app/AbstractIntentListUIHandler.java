 ...
 * output class name
 */
public abstract class AbstractIntentListUIHandler extends com.kingdee.eas.framework.app.TreeListUIHandler

{
	...
	public void handleActionSpecialAgio(RequestContext request,ResponseContext response, Context context) throws Exception {
		_handleActionSpecialAgio(request,response,context);
	}
	protected void _handleActionSpecialAgio(RequestContext request,ResponseContext response, Context context) throws Exception {
	}
}