 ...
 * output class name
 */
public abstract class AbstractRoomSourceListUIHandler extends com.kingdee.eas.framework.app.TreeListUIHandler

{
	...
	public void handleActionRoomImport(RequestContext request,ResponseContext response, Context context) throws Exception {
		_handleActionRoomImport(request,response,context);
	}
	protected void _handleActionRoomImport(RequestContext request,ResponseContext response, Context context) throws Exception {
	}
	public void handleActionRoomDefine(RequestContext request,ResponseContext response, Context context) throws Exception {
		_handleActionRoomDefine(request,response,context);
	}
	protected void _handleActionRoomDefine(RequestContext request,ResponseContext response, Context context) throws Exception {
	}
	public void handleActionRoomSourceDisFixed(RequestContext request,ResponseContext response, Context context) throws Exception {
		_handleActionRoomSourceDisFixed(request,response,context);
	}
	protected void _handleActionRoomSourceDisFixed(RequestContext request,ResponseContext response, Context context) throws Exception {
	}
