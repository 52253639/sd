 ...
 * output class name
 */
public abstract class AbstractCustomerEditUIHandler extends com.kingdee.eas.framework.app.EditUIHandler

{
	...
	protected void _handleActionAddCommerceChance(RequestContext request,ResponseContext response, Context context) throws Exception {
	}
	...
	public void handleActionInsider(RequestContext request,ResponseContext response, Context context) throws Exception {
		_handleActionInsider(request,response,context);
	}
	protected void _handleActionInsider(RequestContext request,ResponseContext response, Context context) throws Exception {
	}
	public void handleActionXQAddLine(RequestContext request,ResponseContext response, Context context) throws Exception {
		_handleActionXQAddLine(request,response,context);
	}
	protected void _handleActionXQAddLine(RequestContext request,ResponseContext response, Context context) throws Exception {
	}
	public void handleActionXQRemoveLine(RequestContext request,ResponseContext response, Context context) throws Exception {
		_handleActionXQRemoveLine(request,response,context);
	}
	protected void _handleActionXQRemoveLine(RequestContext request,ResponseContext response, Context context) throws Exception {
	}
}