...
public abstract class AbstractPurchaseManageEditUI extends com.kingdee.eas.fdc.sellhouse.client.BaseTransactionEditUI
{
    ...
    public void initUIContentLayout()
    {
        ...
        contCreateTime.setBounds(new Rectangle(13, 675, 270, 19));
        this.add(contCreateTime, new KDLayout.Constraints(13, 675, 270, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        contAuditor.setBounds(new Rectangle(370, 653, 270, 19));
        this.add(contAuditor, new KDLayout.Constraints(370, 653, 270, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contAuditDate.setBounds(new Rectangle(370, 675, 270, 19));
        this.add(contAuditDate, new KDLayout.Constraints(370, 675, 270, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        contStandardTotalAmount.setBounds(new Rectangle(697, 52, 270, 19));
        panelCommonInfo.add(contStandardTotalAmount, new KDLayout.Constraints(697, 52, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        contAttachPropertyTotalAmount.setBounds(new Rectangle(697, 74, 270, 19));
        panelCommonInfo.add(contAttachPropertyTotalAmount, new KDLayout.Constraints(697, 74, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
...
panelBizReview.setLayout(new BorderLayout(0, 0));        panelBizReview.add(tblBizReview, BorderLayout.CENTER);
        ...
        panelBiz.putClientProperty("OriginalBounds", new Rectangle(0, 0, 988, 229));        conRecommendCard.setBounds(new Rectangle(353, 116, 270, 19));
        panelBiz.add(conRecommendCard, new KDLayout.Constraints(353, 116, 270, 19, KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contSeller.setBounds(new Rectangle(698, 116, 270, 19));
        panelBiz.add(contSeller, new KDLayout.Constraints(698, 116, 270, 19, KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contBizAdscriptionDate.setBounds(new Rectangle(698, 28, 270, 19));
        panelBiz.add(contBizAdscriptionDate, new KDLayout.Constraints(698, 28, 270, 19, KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        contValuationType.setBounds(new Rectangle(698, 6, 270, 19));
        panelBiz.add(contValuationType, new KDLayout.Constraints(698, 6, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contBizDate.setBounds(new Rectangle(353, 28, 270, 19));
        panelBiz.add(contBizDate, new KDLayout.Constraints(353, 28, 270, 19, KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        contAgioScheme.setBounds(new Rectangle(9, 50, 270, 19));
        panelBiz.add(contAgioScheme, new KDLayout.Constraints(9, 50, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contAgioDes.setBounds(new Rectangle(353, 50, 507, 19));
        panelBiz.add(contAgioDes, new KDLayout.Constraints(353, 50, 507, 19, KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contDealTotalAmount.setBounds(new Rectangle(9, 72, 270, 19));
        panelBiz.add(contDealTotalAmount, new KDLayout.Constraints(9, 72, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contDealBuildPrice.setBounds(new Rectangle(353, 72, 270, 19));
        panelBiz.add(contDealBuildPrice, new KDLayout.Constraints(353, 72, 270, 19, KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contDealRoomPrice.setBounds(new Rectangle(698, 72, 270, 19));
        panelBiz.add(contDealRoomPrice, new KDLayout.Constraints(698, 72, 270, 19, KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contContractTotalAmount.setBounds(new Rectangle(9, 94, 270, 19));
        panelBiz.add(contContractTotalAmount, new KDLayout.Constraints(9, 94, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contContractBuildPrice.setBounds(new Rectangle(353, 94, 270, 19));
        panelBiz.add(contContractBuildPrice, new KDLayout.Constraints(353, 94, 270, 19, KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contContractRoomPrice.setBounds(new Rectangle(698, 94, 270, 19));
        panelBiz.add(contContractRoomPrice, new KDLayout.Constraints(698, 94, 270, 19, KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contAgio.setBounds(new Rectangle(9, 138, 270, 19));
        panelBiz.add(contAgio, new KDLayout.Constraints(9, 138, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contRecommendPerson.setBounds(new Rectangle(698, 160, 270, 19));
        panelBiz.add(contRecommendPerson, new KDLayout.Constraints(698, 160, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        btnChooseAgio.setBounds(new Rectangle(871, 50, 97, 19));
        panelBiz.add(btnChooseAgio, new KDLayout.Constraints(871, 50, 97, 19, KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contDes.setBounds(new Rectangle(9, 204, 962, 19));
        panelBiz.add(contDes, new KDLayout.Constraints(9, 204, 962, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contPlanSignDate.setBounds(new Rectangle(353, 138, 270, 19));
        panelBiz.add(contPlanSignDate, new KDLayout.Constraints(353, 138, 270, 19, KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contActualArea.setBounds(new Rectangle(698, 182, 270, 19));
        panelBiz.add(contActualArea, new KDLayout.Constraints(698, 182, 270, 19, KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contPreArea.setBounds(new Rectangle(353, 182, 270, 19));
        panelBiz.add(contPreArea, new KDLayout.Constraints(353, 182, 270, 19, KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contPlanningCompensate.setBounds(new Rectangle(9, 160, 270, 19));
        panelBiz.add(contPlanningCompensate, new KDLayout.Constraints(9, 160, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contPurAmount.setBounds(new Rectangle(698, 138, 270, 19));
        panelBiz.add(contPurAmount, new KDLayout.Constraints(698, 138, 270, 19, KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contCashSalesCompensate.setBounds(new Rectangle(353, 160, 270, 19));
        panelBiz.add(contCashSalesCompensate, new KDLayout.Constraints(353, 160, 270, 19, KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contPlanningArea.setBounds(new Rectangle(9, 182, 270, 19));
        panelBiz.add(contPlanningArea, new KDLayout.Constraints(9, 182, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contRecommend.setBounds(new Rectangle(9, 116, 270, 19));
        panelBiz.add(contRecommend, new KDLayout.Constraints(9, 116, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        //conRecommendCard
        ...
        conPayList.getContentPane().putClientProperty("OriginalBounds", new Rectangle(13, 429, 989, 214));        contAFundAmount.setBounds(new Rectangle(305, 4, 270, 19));
