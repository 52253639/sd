 ...
 * output class name
 */
public class HopedRoomsAnalyseFilterUI extends AbstractHopedRoomsAnalyseFilterUI {
	
	private static final String IS_SHE_SYS = "isSalehouseSys";

	private static final String IS_TEN_SYS= "isTenancySys";
	...
	public void clear() {
		...
		this.chkIsSellHouseSystem.setSelected(true);
		this.chkIsTenancySystem.setSelected(true);
	...
	public CustomerParams getCustomerParams() {
		...
		param.add(IS_SHE_SYS, this.chkIsSellHouseSystem.isSelected());
		param.add(IS_TEN_SYS, this.chkIsTenancySystem.isSelected());
	...
	public void setCustomerParams(CustomerParams cp) {
		...
		this.chkIsSellHouseSystem.setSelected(para.getBoolean(IS_SHE_SYS));
		this.chkIsTenancySystem.setSelected(para.getBoolean(IS_TEN_SYS));
		this.initControlByDateType();
