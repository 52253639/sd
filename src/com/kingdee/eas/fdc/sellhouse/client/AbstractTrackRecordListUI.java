 ...
 * output class name
 */
public abstract class AbstractTrackRecordListUI extends com.kingdee.eas.fdc.basedata.client.FDCBillListUI
{
     ...
     */
    public AbstractTrackRecordListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractTrackRecordListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.fdc.sellhouse.app", "TrackRecordQuery");
    ...
    public void initUIContentLayout()
    {
        ...
        kDSplitPane1.setBounds(new Rectangle(7, 7, 999, 615));
        this.add(kDSplitPane1, new KDLayout.Constraints(7, 7, 999, 615, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        //kDSplitPane1
        kDSplitPane1.add(tblMain, "right");
        kDSplitPane1.add(kDTreeView, "left");
        //kDTreeView
        kDTreeView.setTree(treeSellProject);
    ...
    public void initUIMenuBarLayout()
    {
        ...
        menuEdit.add(menuItemExcelBatchImport);
        //MenuService
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.sellhouse.app.TrackRecordListUIHandler";
	}
    ...
    protected class ActionExcelBatchImport extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractTrackRecordListUI.this, "ActionExcelBatchImport", "actionExcelBatchImport_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.sellhouse.client", "TrackRecordListUI");
    }
