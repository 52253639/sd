 ...
 * output class name
 */
public class checkRptUITotal extends AbstractcheckRptUITotal
{
    private static final Logger logger = CoreUIObject.getLogger(checkRptUITotal.class);
    
    /**
     * output class constructor
     */
    public checkRptUITotal() throws Exception
    {
        super();
    }
