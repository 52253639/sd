 ...
 * output class name
 */
public class Copy_checkRptUI extends AbstractCopy_checkRptUI
{
    private static final Logger logger = CoreUIObject.getLogger(Copy_checkRptUI.class);
    
    /**
     * output class constructor
     */
    public Copy_checkRptUI() throws Exception
    {
        super();
    }
    ...
    /**
     * output actionSet_actionPerformed
     */
